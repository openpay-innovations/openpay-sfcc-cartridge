...
server.prepend(
    ...
    function (req, res, next) {
        ...
        Transaction.wrap(function () {
            ...
            } else if (paymentMethodID === 'OPENPAY') {
...
server.prepend('PlaceOrder', server.middleware.https, function (req, res, next) {
    ...
    if (openpayInstruments.length > 0 && openpayInstruments.length === paymentInstruments.length) {
        res.json({
            error: true,
            errorMessage: Resource.msg('openpay.redirect.message', 'openpay', null)
        });
